...
# Selection of response
  A response variable that will give the desired imformation is the amount of digits the test person can remember. As mentioned, one could also conut words instead of digits. Also, we choose to count the numbers in a sequence that are at the right spot, meaning that the first spot with 
