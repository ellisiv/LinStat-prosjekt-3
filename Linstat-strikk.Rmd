...
# Introduction
  ...
  An important part of the memory is the short-term memory, which is the brains capacity to remember a small amount of information for a small period of time. If we know how to utilize our capacity in the best possible way, we will be able to remember more efficiently and this is a valuable trait in our society. This is why we in our experiment is testing which factors that can be useful and thus we can evolve our learning techniques.
